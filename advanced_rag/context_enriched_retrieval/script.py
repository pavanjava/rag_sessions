...
class PrevNextPostprocessorDemo:
    def __init__(self, openai_api_key: str = None, data_directory: str = "data", chunk_size: int = 512):
        ...
        if openai_api_key is not None:
            ...
            Settings.llm = Ollama(model=os.environ.get("ollama_llm_model_id"), base_url=os.environ.get("embedding_host"), request_timeout=300)
...
if __name__ == "__main__":
    ...
    print(demo.query_with_postprocessor(query="What are the challenges of climatic change?"))

    print("\nQuery without Postprocessor:")
    print(demo.query_without_postprocessor(query="What are the challenges of climatic change?"))
